      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="bg-[#040A1A] border border-[#27272a] rounded-xl p-4 sm:p-6">
          ...
          <div id="resume-preview" class="mt-3 text-xs text-[#52525b] flex items-center gap-2">
            <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
...
function bindUploadEvents() {
  ...
  window.handleFile = async (file) => {
    ...
    document.getElementById('resume-preview').innerHTML = `
      <svg class="w-3.5 h-3.5 text-[#34d399] shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
      <span class="text-white font-medium truncate">${file.name}</span>
      <span class="text-[#52525b] shrink-0">·</span>
      <span class="shrink-0">${(file.size / 1024).toFixed(0)} KB</span>
      <span class="text-[#34d399] shrink-0">· Ready</span>`
...
JavaScript, React, HTML, CSS, Git, Node.js`
    ...
    document.getElementById('resume-preview').innerHTML = `
      <svg class="w-3.5 h-3.5 text-[#34d399] shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
